...
<section class="py-16 bg-primary relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            <a href="https://wa.me/628121979319?text=Halo+PT+Aisi+Aiken+Indonesia,+saya+membutuhkan+rekomendasi+produk+fire+protection."
               target="_blank" rel="noopener noreferrer"
               class="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold text-white text-sm
            ...
            <a href="{{ route('contact.index') }}"
               class="inline-flex items-center gap-2 px-6 py-3 rounded-lg border-2 border-white/60 text-white font-semibold text-sm
                      hover:border-white hover:bg-white/10 transition-all duration-200 hover:-translate-y-0.5">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
