...
@php
    ...
    // WhatsApp deep-link with pre-filled product name
    $waMessage = 'Halo PT Aisi Aiken Indonesia, saya tertarik untuk berkonsultasi mengenai produk ' . $product->name . '.';
    $waUrl     = 'https://wa.me/628121979319?text=' . rawurlencode($waMessage);
@endphp
            ...
            <div class="space-y-6">
                ...
                <div class="pt-2 space-y-3">
                    ...
                    <a href="{{ $waUrl }}"
                       ...
                       class="flex items-center justify-center gap-3 w-full py-4 rounded-xl font-bold text-white text-base
                              transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-green-200"
                    ...
                    <a href="{{ route('contact.index') }}"
                       class="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl border-2 border-primary text-primary font-semibold text-sm
